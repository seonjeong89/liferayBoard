...
import sjkim.service.ReplyLocalService;
...
/**
 * Provides the base implementation for the reply local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link sjkim.service.impl.ReplyLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see sjkim.service.impl.ReplyLocalServiceImpl
 * @generated
 */
public abstract class ReplyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, ReplyLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReplyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>sjkim.service.ReplyLocalServiceUtil</code>.
	 */
	...
	public Reply createReply(long replyNo) {
		return replyPersistence.create(replyNo);
	}
	...
	public Reply deleteReply(long replyNo) throws PortalException {
		return replyPersistence.remove(replyNo);
	}
	...
	public Reply deleteReply(Reply reply) {
		return replyPersistence.remove(reply);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Reply.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return replyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return replyPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return replyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return replyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return replyPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Reply fetchReply(long replyNo) {
		return replyPersistence.fetchByPrimaryKey(replyNo);
	}
	...
	public Reply getReply(long replyNo) throws PortalException {
		return replyPersistence.findByPrimaryKey(replyNo);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(replyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Reply.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("replyNo");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(replyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Reply.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("replyNo");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return replyLocalService.deleteReply((Reply)persistedModel);
	}

	public BasePersistence<Reply> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return replyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Reply> getReplies(int start, int end) {
		return replyPersistence.findAll(start, end);
	}
	...
	public int getRepliesCount() {
		return replyPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReplyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		replyLocalService = (ReplyLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReplyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = replyPersistence.getDataSource();
	...
	protected ReplyLocalService replyLocalService;
