...
import sjkim.exception.NoSuchFooException;

import sjkim.model.Foo;
import sjkim.model.impl.FooImpl;
import sjkim.model.impl.FooModelImpl;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.sjkim.model.Foo"),
			true);
	}
