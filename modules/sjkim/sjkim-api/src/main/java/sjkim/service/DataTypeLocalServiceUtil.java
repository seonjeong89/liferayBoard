 ...
 * <code>sjkim.service.impl.DataTypeLocalServiceImpl</code> and
...
public class DataTypeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sjkim.service.impl.DataTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static sjkim.model.DataType addDataType(
		sjkim.model.DataType dataType) {

		return getService().addDataType(dataType);
	}

	public static sjkim.model.DataType cloneDataType(
			long dataTypeNo, String dataTypeVersion, String dataTypeWriter)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().cloneDataType(
	 ...
	 */
	public static sjkim.model.DataType createDataType(long dataTypeNo) {
		return getService().createDataType(dataTypeNo);
	}

	public static void daleteDataType(long dataTypeNo)
		throws com.liferay.portal.kernel.exception.PortalException {

		getService().daleteDataType(dataTypeNo);
	}
	 ...
	 */
	public static sjkim.model.DataType deleteDataType(
		sjkim.model.DataType dataType) {
	 ...
	 */
	public static sjkim.model.DataType deleteDataType(long dataTypeNo)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().deleteDataType(dataTypeNo);
	}
	...
	public static sjkim.model.DataType fetchDataType(long dataTypeNo) {
		return getService().fetchDataType(dataTypeNo);
	}
	 ...
	 * @throws PortalException if a data type with the primary key could not be found
	 */
	public static sjkim.model.DataType getDataType(long dataTypeNo)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().getDataType(dataTypeNo);
	}
	 ...
	 */
	public static java.util.List<sjkim.model.DataType> getDataTypes(
		int start, int end) {
	...
	public static sjkim.model.DataType insertDataType(
		...
		return getService().insertDataType(
	...
	public static java.util.List<sjkim.model.DataType> searchDataTypeList(
		String keyword, int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<sjkim.model.DataType>
			orderByComparator) {

		return getService().searchDataTypeList(
			keyword, start, end, orderByComparator);
	}

	public static int searchDataTypeListCount(String keyword) {
		return getService().searchDataTypeListCount(keyword);
	}
	 ...
	 */
	public static sjkim.model.DataType updateDataType(
		sjkim.model.DataType dataType) {

		return getService().updateDataType(dataType);
	}

	public static sjkim.model.DataType updateDataTypeAll(
			long dataTypeNo,
			java.util.Map<java.util.Locale, String> dataTypeExplanation,
			java.util.Map<java.util.Locale, String> dataTypeDisplayName,
		...
		return getService().updateDataTypeAll(
	...
	public static sjkim.model.DataType updateDataTypeWithoutFile(
			long dataTypeNo,
			java.util.Map<java.util.Locale, String> dataTypeExplanation,
			java.util.Map<java.util.Locale, String> dataTypeDisplayName,
			String dataTypeStructure, String dataTypeWriter)
		...
		return getService().updateDataTypeWithoutFile(
			dataTypeNo, dataTypeExplanation, dataTypeDisplayName,
			dataTypeStructure, dataTypeWriter);
	}

	public static sjkim.model.DataType upgradeDataType(
			long dataTypeNo, String dataTypeWriter)
		throws com.liferay.portal.kernel.exception.PortalException {

		return getService().upgradeDataType(dataTypeNo, dataTypeWriter);
	}
