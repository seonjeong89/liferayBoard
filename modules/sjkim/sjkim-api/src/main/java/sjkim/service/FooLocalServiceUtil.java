 ...
 * <code>sjkim.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>sjkim.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static sjkim.model.Foo addFoo(sjkim.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static sjkim.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static sjkim.model.Foo deleteFoo(sjkim.model.Foo foo) {
	 ...
	 */
	public static sjkim.model.Foo deleteFoo(long fooId)
	...
	public static sjkim.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static sjkim.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static sjkim.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static sjkim.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<sjkim.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	public static java.util.List<sjkim.model.Foo> getFoosByUuidAndCompanyId(
	...
	public static java.util.List<sjkim.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<sjkim.model.Foo>
			orderByComparator) {
	 ...
	 */
	public static sjkim.model.Foo updateFoo(sjkim.model.Foo foo) {
