...
public interface UploadFileLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>sjkim.service.impl.UploadFileLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the upload file local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UploadFileLocalServiceUtil} if injection and service tracking are not available.
	 */
