...
public interface DataTypeLocalService
	...
	public DataType insertDataType(
		...
		Map<Locale, String> dataTypeExplanation,
		Map<Locale, String> dataTypeDisplayName, String writer,
		String dataTypeStructure, String RealfileName, String uploadFileName,
		String contentType, String realPath);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DataType> searchDataTypeList(
	...
	public DataType updateDataTypeAll(
			long dataTypeNo, Map<Locale, String> dataTypeExplanation,
			Map<Locale, String> dataTypeDisplayName, String dataTypeStructure,
			String dataTypeWriter, String RealfileName, String uploadFileName,
			String contentType, String realPath)
		throws PortalException;

	public DataType updateDataTypeWithoutFile(
			long dataTypeNo, Map<Locale, String> dataTypeExplanation,
			Map<Locale, String> dataTypeDisplayName, String dataTypeStructure,
			String dataTypeWriter)
		throws PortalException;

	public DataType upgradeDataType(long dataTypeNo, String dataTypeWriter)
		throws PortalException;
