...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public sjkim.model.Foo addFoo(sjkim.model.Foo foo) {
	 ...
	 */
	@Override
	public sjkim.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public sjkim.model.Foo deleteFoo(sjkim.model.Foo foo) {
	 ...
	 */
	@Override
	public sjkim.model.Foo deleteFoo(long fooId)
	...
	@Override
	public sjkim.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public sjkim.model.Foo fetchFooByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 */
	@Override
	public sjkim.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public sjkim.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<sjkim.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<sjkim.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	@Override
	public sjkim.model.Foo updateFoo(sjkim.model.Foo foo) {
