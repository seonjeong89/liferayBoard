...
@Component(
		...
		property = {
				...
				"mvc.command.name="+SjkimWebCommandKeys.BOARD_REPLY_UPDATE_RESOURCE
		},
		service = MVCResourceCommand.class
		)

public class BoardReplyUpdateMVCResourceCommand implements MVCResourceCommand {
	...
	public boolean serveResource(ResourceRequest resourceRequest, ResourceResponse resourceResponse)
		...
		// 서비스에 정보 넘겨주고 update 한다.
		try {
			ReplyLocalServiceUtil.updateReply(replyNo, replyContent);
		} catch(Exception e) {
			e.printStackTrace();
		}
		return false;
