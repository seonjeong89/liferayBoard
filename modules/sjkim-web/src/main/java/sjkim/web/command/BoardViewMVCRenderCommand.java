...
@Component(
		...
		property = {
				...
				"mvc.command.name="+SjkimWebCommandKeys.BOARD_VIEW_RENDER
		},
		service = MVCRenderCommand.class
		)


public class BoardViewMVCRenderCommand implements MVCRenderCommand{
	//로그 선언
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		try {
			board = BoardLocalServiceUtil.increaseViewCount(boardNo);
