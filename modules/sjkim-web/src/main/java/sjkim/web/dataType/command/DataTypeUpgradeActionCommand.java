...
@Component(
		...
		property = {
				...
				"mvc.command.name="+SjkimWebCommandKeys.DATATYPE_UPGRADE_ACTION
		},
		service = MVCActionCommand.class
		)

public class DataTypeUpgradeActionCommand implements MVCActionCommand {
	...
	public boolean processAction(ActionRequest actionRequest, ActionResponse actionResponse) throws PortletException {
		...
		// 서비스에 정보 넘겨주고 upgrade 한다.
	
		try {
			DataType dataType = DataTypeLocalServiceUtil.upgradeDataType(dataTypeNo, dataTypeWriter);
