...
@Component(
		...
		property = {
				...
				"mvc.command.name="+SjkimWebCommandKeys.DATATYPE_REGIST_RENDER
		},
		service = MVCRenderCommand.class
		)


public class DataTypeRegistRenderCommand implements MVCRenderCommand{

	@Override
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		return "/dataType/dataTypeRegistForm.jsp";
	}
