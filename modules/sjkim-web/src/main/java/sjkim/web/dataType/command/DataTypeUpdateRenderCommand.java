...
@Component(
		...
		property = {
				...
				"mvc.command.name="+SjkimWebCommandKeys.DATATYPE_UPDATE_RENDER
		},
		service = MVCRenderCommand.class
		)


public class DataTypeUpdateRenderCommand implements MVCRenderCommand{
	//로그 선언
	...
	public String render(RenderRequest renderRequest, RenderResponse renderResponse) throws PortletException {
		...
		return "/dataType/dataTypeUpdateForm.jsp";
	}
